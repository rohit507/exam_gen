...
\framebox{
\vbox{
\hbox to 5.75in { {\small\bf {{ class_name }}, {{ semester }}
\hfill {{ instructors }} }  }
\vspace{7mm}
...
\homework{ {{ exam_name }} \solution{ SOLUTIONS }}{ {{ date}} }
...
{\sc \textbf{Your Name:}} {{ student_data.Name }}
